...
public class Launcher extends javax.swing.JFrame {
  ...
  public void checkVersion() {
    try {
      BufferedReader reader = new BufferedReader(new InputStreamReader(
        new URL("http://vivan doshi.github.io/jfcraft/version.html").openStream()));
      ...
      JOptionPane.showMessageDialog(this,
        "A newer version of jfCraft is available! (v" + line + ")\r\nPlease goto http://vivan doshi.github.io/jfcraft to download it",
        "Info",
  ...
  public void initWeb() {
    try {
      ...
      html.setPage(new URL("http://vivan doshi.github.io/jfcraft/news.html"));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
